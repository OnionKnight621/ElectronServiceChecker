...
import checkUriHandler from "./handlers/checkUriHandler";
import getChromePathHandler from "./handlers/getChromePathHandler";
import getTxtFileHandler from "./handlers/getTxtFileHndler";
import startBrowserHandler, { IStartBrowserHandler } from "./handlers/startBrowserHandler";
...
ipcMain.on(API_TRIGGER_CHANNELS.TRIGGER_GET_TXT_FILE, () => getTxtFileHandler(mainWindow));

ipcMain.on(
  API_TRIGGER_CHANNELS.TRIGGER_START_BROWSER,
  (e, { chromePath, instances, maxInstances, mainIntervalID, accounts }: IStartBrowserHandler) =>
    startBrowserHandler({mainWindow, chromePath, instances, maxInstances, mainIntervalID, accounts})
);
